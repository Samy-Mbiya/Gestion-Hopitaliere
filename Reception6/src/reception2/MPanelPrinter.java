...
public class MPanelPrinter implements Printable {
    ...
    public void initPrintablePanel()
    {
       ...
       // pageFormat.setOrientation(PageFormat.LANDSCAPE); // Rotation de Jpanel
    }
 
    public void setOrientation(int orientation)
    {
        pageFormat.setOrientation(orientation);
        pageFormat.setOrientation(PageFormat.LANDSCAPE);// Centrer la Jpanel
    }
    ...
    public void setLRMargins(int margin) //MArge GAUCHE
    {
    ...
    public void setTBMargins(int margin)//Marge HAUT
    {
        Paper paper = pageFormat.getPaper();
