		...
		<div class="row">
			<div class="span3 bs-docs-sidebar">
				<ul class="nav nav-list bs-docs-sidenav affix-top" id="head">
					...
					<li><a href="Liste_Patients.php"><i class="icon-chevron-right"></i>Liste Exames</a></li>
					<li><a href="Liste_covid.php"><i class="icon-chevron-right"></i>Liste Test Covid</a></li>
